        ...
        {loading ? (
          ...
          <ListGroup variant="flush">
            <ListGroup.Item className={"orderHistHeading"} key={"heading"}>
              <Row>
                <Col className={"orderHistoryHeading"} md={2}>
                  <strong>Order ID</strong>
                </Col>
                <Col className={"orderHistoryHeading"} md={3}>
                  Total Price
                </Col>
                <Col className={"orderHistoryHeading"} md={3}>
                  Paid
              ...
              orders.orderHistory.map((order) => (
                ...
                >
                  ...
                  <Row>
                    ...
                    <Col className={"orderHistoryData"} md={3}>
